...
import { renderStatusColor } from '../../utilities/renderStatus';
  ...
  return (
    ...
    >
      <Link to={`invoice/${invoice.id}`} className="h-full">
        <div className="text-[#121212] w-full grid grid-cols-[1fr_1fr] md:grid-cols-[7rem_9rem_1fr_auto_auto] items-center">
          ...
          <div
            className={`col-[2_/_3] row-[2_/_4] md:row-auto md:col-auto ml-auto md:mx-[43px] text-[14px] font-bold capitalize flex justify-center items-center w-[90px] h-[34px] md:w-[110px] md:h-[40px] rounded-[12px] ${renderStatusColor(
              invoice.status
            )}`}
          >
            {invoice.status}
